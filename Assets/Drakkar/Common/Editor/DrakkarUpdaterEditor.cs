...
namespace Drakkar
{
	...
	public class DrakkarUpdaterEditor : Editor
	{
		...
		#endif
			DrakkarEditor.PropertyInspector(Serialized,"PreUpdateSlots");
			DrakkarEditor.PropertyInspector(Serialized,"NormalUpdateSlots");
			DrakkarEditor.PropertyInspector(Serialized,"PostUpdateSlots");
			EditorGUILayout.Space();
			DrakkarEditor.PropertyInspector(Serialized,"PreLateUpdateSlots");
			DrakkarEditor.PropertyInspector(Serialized,"LateUpdateSlots");
			DrakkarEditor.PropertyInspector(Serialized,"PostLateUpdateSlots");
			EditorGUILayout.Space();
			DrakkarEditor.PropertyInspector(Serialized,"FixedUpdateSlots");
